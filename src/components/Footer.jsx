            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="scroll-reveal grid md:grid-cols-2 lg:grid-cols-3 gap-12 mb-16" data-delay="1">
                    ...
                    <div className="lg:col-span-1">
                        <div className="flex items-center gap-2 mb-6 cursor-pointer group">
                            <Sparkles className="h-8 w-8 text-brand-teal group-hover:animate-pulse" />
                            <span className="text-2xl font-bold text-white tracking-tight">Spotless</span>
                        </div>
                ...
                <div className="scroll-reveal pt-8 border-t border-white/10 text-center md:flex md:justify-between items-center text-sm" data-delay="2">
                    <p className="text-[#93b8b1] mb-4 md:mb-0">
                        &copy; {new Date().getFullYear()} Spotless Cleaning. All rights reserved.
                    </p>
